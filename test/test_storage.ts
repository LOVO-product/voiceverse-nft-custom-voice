...
describe.skip("Storage", function () {
  ...
  beforeEach(async function () {
    ...
    const Original = await ethers.getContractFactory("Storage");
  ...
  describe("Mint", function () {
    it("test3", async function () {
      ...
      const tx = await original.connect(owner).mintNFT(owner.address, "https://lovo.mypinata.cloud/ipfs/QmVmYmnrKR9We9QqHsMTNC76iBA8kAeGr6ykwGpVgQbnZQ/");
